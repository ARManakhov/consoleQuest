...
public class Player extends Character {
    ...
    public double PlayerAttackRange = 200;
    ...
    public void PlayerAttack(Character enemy) {
        double x = (enemy.getRealXPos() - realXPos)*(enemy.getRealXPos() - realXPos);
        double y = (enemy.getRealYPos() - realYPos)*(enemy.getRealYPos() - realYPos);
        double attackrange = Math.sqrt(x + y);
        if ((KeyManager.getMousePresetButt("PRIMARY") == true) && (hp > 0) && (enemy.getHp() > 0) && (attackrange < PlayerAttackRange)) {
