...
public class KeyManager {
    ...
    private static final String DEFAULT_ESC_BUTTON = "ESCAPE"; // добавлен Айнуром для лидера
    ...
    private static String buttESC = DEFAULT_ESC_BUTTON; // добавлен Айнуром для лидера
